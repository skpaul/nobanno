                ...
                <div class="main-top-nav-container">
                    <div class="container-fluid">
                        <nav id="mainTopNav" class="main-top-nav">
                            ...
                            <a href="$baseUrl/applicant-copy/applicant-copy.php"><span class="m-icons">article</span>Applicant Copy</a>
                            <a href="$baseUrl/court-higher/written/admit-card/hc-written-admit-card.php"><span class="m-icons">account_box</span>Admit Card</a>
                            <a href="$baseUrl/payment-status/payment-status.php"><span class="m-icons">done_outline</span>Payment Status</a>
                            <a href="$baseUrl/recover-userid/recover-userid.php"><span class="m-icons">perm_identity</span>Recover User ID</a>
                            <a href="https://www.photobip.com" target="_blank"><span class="m-icons">crop</span>Photo Resizer</a>
                            <a href="$baseUrl/help/customer-care.php"><span class="m-icons">phone_in_talk</span>Customer Care</a>
                        </nav> 
                    </div>
                </div>
        HTML;
