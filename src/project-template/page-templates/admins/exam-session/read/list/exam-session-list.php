...
<body>
    <div class="master-wrapper">
        ...
        <main class="">
            <div class="container-fluid d-flex flex-wrap">
                <h1 class="width-full mt-150 accent-fg">Exam Session List
                ...
                <div class="content ">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="field">
                                            ...
                                            <input name="applicationType" id="applicationType" type="text" class="validate autoComplete" data-column="applicationType" data-required="optional" placeholder="type something to get suggestion">
                                        </div>
                                    </div>
                    ...
                    <table id="meetingData" class="" style="width: 100%;">
                        <thead>
                            <tr>
                                <th class="serialColumn">SL.</th>
                                <th class="dateColumn" title="Click to change order">Application Type</th>
                                <th class="startColumn" title="Click to change order">IsActive</th>
                                <th class="endColumn" title="Click to change order">Application Start Date</th>
                                <th class="endColumn" title="Click to change order">Application End Date</th>
                                <th title="Click to change order">Admit Card Start Date</th>
                                <th title="Click to change order">Admit Card End Date</th>
    ...
    <script>
        ...
        $(function() {
            ...
            function fillDatatable(applicationType = '') {
                var dataTable =
                    ...
                    $('#meetingData').DataTable({
                        ...
                        "ajax": {
                            url: baseUrl + '/admins/exam-session/read/list/exam-session-list-data.php?sid=1',
                            type: "POST",
                            data: {
                        ...
                        "columnDefs": [
                            ...
                            },
                            {
                                "targets": 7,
                                "render": function(data, type, row, meta) {
                                    return '<div class="d-flex"><a href="' + baseUrl + '/admins/exam-session/update/edit-exam-session.php?config-id=' + data.configId + '"><i class="material-icons"> edit </i></a><a href="' + baseUrl + '/admins/exam-session/read/details/exam-session-details.php?config-id=' + data.configId + '"><i class="material-icons"> info </i></a><a href="' + baseUrl + '/admins/exam-session/delete/delete-exam-session.php?config-id=' + data.configId + '"><i class="material-icons"> delete </i></a></div>';
                                }
                            }
                        ], //columnDefs ends
                        ...
                        "columns": [
                            ...
                            {
                                "data": "admitCardStartDatetime"
                            },
                            {
                                "data": "admitCardEndDatetime"
                            },
                            {
                                "data": null,
                            }
            ...
            $(".autoComplete").autocomplete({
                ...
                source: function(request, response){
                    ...
                    let url = baseUrl + '/admins/exam-session/read/list/exam-session-auto-complete-data.php?column=' + columnName;
                    $.get(  url,  
                            {
                                term:request.term
                            }, 
