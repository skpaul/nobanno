<?php
    ...
    defined("BASE_URL") or define("BASE_URL", "http://localhost/bar-council/lower-court/registration"); 
    ...
    defined("APPLICATION_TYPE") or define("APPLICATION_TYPE", "Registration"); //Enrolment  //Written   //Viva   //Etc.
    ...
    defined("SECRET_KEY") or define("SECRET_KEY", "jlhgUIv53JgDwF4rE1kK63Fdgk");
