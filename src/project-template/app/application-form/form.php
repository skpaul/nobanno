...
//if "registration-id" key found in query string, redirect to the sorry page.
if (!isset($_GET["registration-id"]) || empty(trim($_GET["registration-id"]))) HttpHeader::redirect(BASE_URL . "/sorry.php?msg=Invalid request.");
...
if (count($registrations) != 1) {
    HttpHeader::redirect(BASE_URL . "/sorry.php?msg=Registration information not found.");
}

$registration = $registrations[0];
//NOTE: Pupilage contract date may come either registration or reappear list table,
$pupilageContractDate = $registration->pupilageContractDate;
...
<head>
    ...
    <?php
    Required::gtag()->metaTags()->favicon()->css()->bootstrapGrid()->sweetModalCSS()->airDatePickerCSS();
    ?>
