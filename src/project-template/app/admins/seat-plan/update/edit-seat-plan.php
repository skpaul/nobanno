<?php
    ...
    if(count($seatDetails) != 1){
        HttpHeader::redirect(BASE_URL . "/admins/seat-plan/read/list/seat-plan-list.php");
    }  
    ...
    <div class="master-wrapper">
        ...
        <main class="">
            <div class="container-fluid d-flex flex-wrap">
                <h1 class="width-full mt-150 accent-fg text-center">Edit Seat Plan
                ...
                <div class="content ">
                    <?php echo $seatId; ?>
                    <form action="<?=BASE_URL?>/admins/seat-plan/update/edit-seat-plan-processor.php?request-id=<?=$encId?>" method="post" class="d-grid gc-3">
                        <!-- venue  --> 
                        <div class="field width-100">  
                            <label class="required">Venue</label>
                            <input name="venue" id="venue" title="" class="validate" data-title="venue" data-datatype="string" data-required="required" data-minlen="" data-maxlen="" value="<?=$seatDetail->venue?>" type="text">
                        </div>

                        <!-- building  --> 
                        <div class="field">  
                            <label class="required">Building</label>
                            <input name="building" id="building" title="" class="validate" data-title="building" data-datatype="string" data-required="required" data-minlen="allow null" data-maxlen="" type="text" value="<?=$seatDetail->building?>">
                        </div>

                        <!-- floor  --> 
                        <div class="field">  
                            <label class="required">Floor</label>
                            <input name="floor" id="floor" title="" class="validate" data-title="floor" data-datatype="string" data-required="required" data-minlen="allow null" data-maxlen="" type="text" value="<?=$seatDetail->floor?>">
                        </div>

                        <!-- room  --> 
                        <div class="field">  
                            <label class="required">Room</label>
                            <input name="room" id="room" title="" class="validate" data-title="room" data-datatype="integer" data-required="required" data-minlen="" maxlength="4" type="text" value="<?=$seatDetail->room?>">
                        </div>
                       
                        <!-- start_roll  --> 
                        <div class="field">  
                            <label class="required">Start Roll</label>
                            <input name="start_roll" id="start_roll" title="" class="validate" data-title="start_roll" data-datatype="integer"  data-required="required"  maxlength="6" data-maxval="" type="text" value="<?=$seatDetail->start_roll?>">
                        </div>
                        <!-- end_roll  --> 
                        <div class="field">  
                            <label class="required">End Roll</label>
                            <input name="end_roll" id="end_roll" title="" class="validate" data-title="end_roll" data-datatype="integer"  data-required="required"  maxlength="6" type="text" value="<?=$seatDetail->end_roll?>">
                        </div>
                         <!-- total  --> 
                         <div class="field">  
                            <label class="required">Total</label>
                            <input name="total" id="total" title="" class="validate" data-title="total" data-datatype="integer"  data-required="required"  maxlength="3" type="text" value="<?=$seatDetail->total?>">
                        </div>
                        <div></div>
                        <div></div>
                        ...
                        <div class="field">
                            ...
                            <input class="form-submit-button outline ml-050" type="submit" value="Update">
                        </div>
