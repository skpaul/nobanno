...
<body>
    <div class="master-wrapper">
        ...
        <main class="">
            <div class="container-fluid d-flex flex-wrap">
                <h1 style="width:100%;" class="mt-150 accent-fg">Registration Update Request List
                ...
                <div class="content ">
                    ...
                    <!-- <a href="download-pending-correction-list.php" class="btn outline">Pending (Excel)</a>
                    <a href="download-approved-correction-list.php" class="btn outline">Approved (Excel)</a>
                    <a href="download-declined-correction-list.php" class="btn outline">Declined (Excel)</a> -->
                    <br>
                    <br>
                    ...
                    <table id="meetingData" class="" style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th title="Click to change order">Registration ID</th>
                                ...
                                <th title="Click to change order">Approval Status</th>
    ...
    <script>
        var baseUrl = '<?php echo BASE_URL; ?>';
        var sid = '1';
        var sessionId = '<?= $encSessionId ?>';
        $(function() {

            // fillDatatable();

            function fillDatatable(applicantName = '', regNo = '', regYear = '') {
                var dataTable =
                    ...
                    $('#meetingData').DataTable({
                        ...
                        "ajax": {
                            url: baseUrl + '/admins/registration-update-request/read/list/registration-update-request-list-data.php?sid=1',
                            type: "POST",
                            data: {
                        ...
                        "columnDefs": [{
                            ...
                            },
                            {
                                "targets": 10,
                                "render": function(data, type, row, meta) {
                                    return '<a href="' + baseUrl + '/admins/registration-update-request/read/details/registration-update-request-details.php?session-id=' + sessionId + '&request-id=' + data.requestId + '"><i class="material-icons"> info </i></a>';
                                }
                            }
                        ], //columnDefs ends
            ...
            $(".autoComplete").autocomplete({
                source: baseUrl + '/admins/registration-update-request/read/list/registration-update-request-list-auto-complete-data.php?column=name',
            });
