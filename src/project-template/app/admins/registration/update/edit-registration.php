    ...
    <div class="master-wrapper">
        ...
        <main class="">
            <div class="container-fluid d-flex flex-wrap">
                <h1 class="width-full mt-150 accent-fg">Edit Registration
                ...
                <?php
                    ...
                    if(count($regiData) != 1){
                        die($json->fail()->message("Your Registration information not found.")->create());
                    }  
                    ...
                    <form action="<?=BASE_URL?>/admins/registration/update/edit-registration-processor.php?session-id=<?=$encSessionId?>" method="post">
                        ...
                        <div class="d-grid gc-2">
                            ...
                            <div class="field">
                                ...
                                <input name="regNo" id="regNo" title="" class="validate integer" data-datatype="integer" data-required="required" data-maxlen="10" type="text" value="<?=$registration->regNo?>" readonly>
                            </div>

                            <!-- regYear  -->
                            <div class="field">
                                <label class="required">Registration Year</label>
                                <input name="regYear" id="regYear" title="" data-datatype="integer" data-required="required" data-exactlen="4" type="text" value="<?=$registration->regYear?>" readonly>
                            </div>
                        </div>
                        <div class="d-grid gc-2">
                            <!-- name  -->
                            <div class="field">
                                ...
                                <input name="name" id="name" title="" class="validate" data-datatype="string" data-required="required"  data-maxlen="150" maxlength="150" type="text" value="<?=$registration->name?>">
                            </div>

                            <!-- fatherName  -->
                            <div class="field">
                                <label class="required">Father Name</label>
                                <input name="fatherName" id="fatherName" title="" class="validate" data-datatype="string" data-required="required" data-maxlen="150" maxlength="150" type="text" value="<?=$registration->fatherName?>">
                            </div>
                        </div>
                        <div class="d-grid gc-1">
                            ...
                            <div class="field">  
                                ...
                                <input name="universityName" id="universityName" title="" class="validate ucase" data-title="universityName" data-datatype="string" data-required="required" maxlength="150" type="text" value="<?=$registration->universityName?>">
                            </div>
                        </div>
                        <div class="d-grid gc-2">
                             ...
                             <div class="field">
                                ...
                                <input name="pupilageContractDate" id="pupilageContractDate" readonly title="" class="validate" data-title="pupilageContractDate" data-datatype="date" data-required="required" type="text"  value="<?=$clock->toString($registration->pupilageContractDate, DatetimeFormat::BdDate())?>">
                            </div>
                            <!-- seniorAdvocateName  -->
                            <div class="field">
                                <label class="required">Senior Advocate Name</label>
                                <input name="seniorAdvocateName" id="seniorAdvocateName" title="" class="validate" data-datatype="string" data-required="required" data-maxlen="150" maxlength="150" type="text" value="<?=$registration->seniorAdvocateName?>">
                            </div>
                        </div>
                        ...
                        <?php
                            ...
                            foreach ($applicantTypes as $type) {
                                $option = $type->name;
                                $selected = $registration->applicantType == $option ? "selected" : "";
                        ...
                        <div class="d-grid gc-2">
                            ...
                            <div class="field">
                                ...
                                <select name="isReRegistered" id="" title="Re-Registration Information" class="validate" data-required="required" >
                                    <option value=""></option>
                                    <option value="yes" <?=$registration->isReRegistered == "1" ? 'selected' : '' ?>>Yes</option>
                                    <option value="no" <?=$registration->isReRegistered == "0" ? 'selected' : '' ?>>No</option>
                                </select>
                            </div>
                            ...
                            <div class="field">
                                ...
                                <select name="hasBarAtLaw" id="" title="Bar-at-law Information" class="validate" data-required="required" >
                                    <option value=""></option>
                                    <option value="yes" <?=$registration->hasBarAtLaw == "1" ? 'selected' : '' ?>>Yes</option>
                                    <option value="no" <?=$registration->hasBarAtLaw == "0" ? 'selected' : '' ?>>No</option>
                                </select>
                            </div>

                            <div class="field">
                                <label class="required">Active?</label>
                                <select name="isActive" id="" class="validate" data-required="required" >
                                    <option value=""></option>
                                    <option value="yes" <?=$registration->isActive == "1" ? 'selected' : '' ?>>Yes</option>
                                    <option value="no" <?=$registration->isActive == "0" ? 'selected' : '' ?>>No</option>
                                </select>
                            </div>
                            <div class="field">
                                <label class="required">Blocked?</label>
                                <select name="isBlocked" id="" class="validate" data-required="required" >
                                    <option value=""></option>
                                    <option value="yes" <?=$registration->isBlocked == "1" ? 'selected' : '' ?>>Yes</option>
                                    <option value="no" <?=$registration->isBlocked == "0" ? 'selected' : '' ?>>No</option>
                                </select>
                            </div>
                        </div>
                        <div class="field mt-100">
                            <input class="button bg-primary mr-025 form-submit-button" type="submit" value="Submit">
                            <a href="<?=BASE_URL?>/admins/registration/read/list/registration-list.php?session-id=<?=$encSessionId?>" class="btn outline">Back</a>
                        </div>
