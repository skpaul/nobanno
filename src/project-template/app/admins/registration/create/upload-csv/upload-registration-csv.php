...
declare(strict_types=1);
    ...
    #region imports
        ...
        Required::Logger() ->Database()->DbSession()->EnDecryptor()->HttpHeader()->Clock()->adminLeftNav()->headerBrand()->applicantHeaderNav()->footer(2);
    #endregion
...
<html lang="en-US">
    ...
    <body>
        <div class="master-wrapper">
            ...
            <main class="">
                <div class="container-fluid d-flex flex-wrap">
                    <h1 style="width:100%;" class="mt-150 accent-fg">Import Registrations
                            ...
                            <table class="fill-parent">
                                <thead>
                                    <tr>
                                        ...
                                        <th>University</th>
                                        <th>Advocate Name</th>
                                        <th>Contract Date <br> <span>dd-mm-yyyy</span></th>
                                        <th>Applicant Type <br> <span>(Regular, Re-Registration, Re-appeared)</span></th>
                                        <th>Bar-at-law <br> <span>(Yes/No)</span></th>
                                    </tr>
                                </thead>
                                <tbody id="tbody">
        ...
        <script src="upload-registration-csv.js?v=<?= time() ?>"></script>
        <script>
