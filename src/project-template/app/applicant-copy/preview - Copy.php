    ...
    <div id="master-wrapper">
        ...
        <main class="previewPage">
            ...
            <div class="container">
                <div class="text-center margin-bottom-25">
                 ...
                 <?php
                    if($applicant->fee == 0){
                 ?>
                    This application is non-editable. If you find any information incorrect here, you can delete this application and resubmit the form. An application can not be deleted after the fee payment. Click here to <a href="delete-confirmation.php?session-id=<?=$encSessionId?>&config-id=<?=$encConfigId?>">Delete Application</a>.
                <?php
                    }
                ?>
            ...
            <div id="pdfdiv" class="non-responsive printable applicant-copy-preview" style="border: 1px solid; margin:0 auto; width: 660px; padding: 10px 20px;">
                ...
                <?php
                $formHeader = "";
                if ($applicant->applicantType == "Re-appearedo") {
                    ...
                    <div class="grid border-bottom">
                        <div class="col-auto">
                            <div class="field border-right">
                                ...
                                <div class="text"><?=$clock->toString($applicant->appliedDatetime, DatetimeFormat::BdDatetime()) ?></div>
                            </div>
                        </div>
                        <div class="col-auto">
                            <div class="field">
                                <label class="border-right fixed-width">Printed On</label>
                                <div class="text"><?=$clock->toString("now", DatetimeFormat::BdDatetime()) ?></div>
                ...
                ?>
                    <div class="smsContent">
                        ...
                        <p>
                            <strong><?= $applicant->userId ?></strong> is your User ID, Please keep this number to pay the application fee Tk. <?= $applicant->requiredFee ?> within <strong><?= $postConfig->lastDateOfTeletalkFeePayment ?></strong> from any Teletalk prepaid mobile phone by SMS.
                        </p>
                        <p>
                  ...
                  <div class="wrapper">
                    <section class="paymentInstruction">
                        ...
                        <ul>
                            ...
                            <li>Application fee payment deadline <span><?= $postConfig->lastDateOfTeletalkFeePayment ?></span>.</li>
